...
Displays the number of IPL matches hosted across different cities.

2. Wickets by Dismissal Type

Analyzes how batters were dismissed (Caught, Bowled, LBW, Run Out, Stumped, etc.).

3. Top Run Scorers

Highlights the leading run scorers in IPL history.

4. Year-wise Run Trend

Shows the trend of total runs scored across IPL seasons.
